...
public class Anagram {
    ...
    public Anagram(FileHelper fileHelper) {
        this.fileHelper = fileHelper;
        this.wordList = this.fileHelper.getLines();
        
    }

    public void findAnagrams(String baseCase, int wordCombination) {
        if (wordCombination == 1) {
            List<String> filteredWordList = filterOneWord(baseCase, wordList);
            findOneWordCombinations(baseCase, filteredWordList);
        }
        else if (wordCombination == 2) {
            List<String> filteredWordList = filterTwoWord(baseCase, wordList);
            findTwoWordCombinations(baseCase, filteredWordList);
        }
        
    }
    
    
    private void findOneWordCombinations(String baseCase, List<String> filteredWordList) {
        int anagramCount = 0;
    ...
    private void findTwoWordCombinations(String baseCase, List<String> filteredWordList) {
        int anagramCount = 0;
        for (int i = 0; i < filteredWordList.size(); i++) {
